                ...
                for (const declarator of node.declarations) {
                    if (declarator.id.type === 'Identifier' && declarator.init) {
                        ...
                        variables.set(varName, {
                            ...
                            value,
                            arrayItems: Array.isArray(value) ? value : null,
...
const findMapContext = (node, variables) => {
    ...
    while (current && depth < maxDepth) {
        if (current.type === 'CallExpression' && ((_a = current.callee) === null || _a === void 0 ? void 0 : _a.type) === 'MemberExpression' && ((_c = (_b = current.callee) === null || _b === void 0 ? void 0 : _b.property) === null || _c === void 0 ? void 0 : _c.name) === 'map') {
            ...
            if (arrayName && (mapCallback === null || mapCallback === void 0 ? void 0 : mapCallback.type) === 'ArrowFunctionExpression') {
                ...
                if ((itemParam === null || itemParam === void 0 ? void 0 : itemParam.type) === 'Identifier') {
                    ...
                    return {
                        ...
                        indexVarName: (indexParam === null || indexParam === void 0 ? void 0 : indexParam.type) === 'Identifier' ? indexParam.name : null
                    };
                }
            }
        }
...
function componentTagger(src, map) {
    ...
    try {
        ...
        (0, estree_walker_1.walk)(ast, {
            enter(node) {
                ...
                (_a = node.attributes) === null || _a === void 0 ? void 0 : _a.forEach((attr) => {
                    var _a, _b;
                    if (attr.type === 'JSXAttribute' && ((_a = attr.value) === null || _a === void 0 ? void 0 : _a.type) === 'JSXExpressionContainer' && ((_b = attr.value.expression) === null || _b === void 0 ? void 0 : _b.type) === 'Identifier') {
        ...
        /* Turbopack expects the sourcemap JSON *string*. */
